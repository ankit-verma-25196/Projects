...
public class ResultMediumActivity extends AppCompatActivity {
    ...
    //static ResultMediumActivity INSTANCE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* for(int tabIndex=0;tabIndex  <tabHost.getTabWidget().getTabCount();tabIndex++)
        ...
        intent1.putExtra("scorecm",scorec);*/
       ...
       /* Intent intent2=new Intent(this,LevelJavaActivity.class);
        intent2.putExtra("scoreJavam",scoreJava);*/
       ...
       /* Intent intent3=new Intent(this,LevelAndroidActivity.class);
        intent3.putExtra("scoreAndroidm",scoreAndroid);*/
        ...
        restart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(ResultMediumActivity.this,CategoryActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public void onBackPressed()
    {
        ...
        AlertDialog.Builder builder=new AlertDialog.Builder(ResultMediumActivity.this);
