...
public class quizhActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        opta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (a == 0) {
                    next = new Button(quizhActivity.this);
                    next.setText("Next");
                    next.setTextColor(getResources().getColor(R.color.changeOption2));
                    next.setOnClickListener(quizhActivity.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder=new AlertDialog.Builder(quizhActivity.this);
                builder.setMessage("Do you want to close the test?")
                        .setCancelable(false)
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Intent i=new Intent(quizhActivity.this,CategoryActivity.class);
                                startActivity(i);
                                finish();
                            }
                        })
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("Do you want to close the test?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Intent i=new Intent(quizhActivity.this,ResultActivity.class);
                                startActivity(i);
                                finish();
                            }
                        })
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("Do you want to go to Home?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Intent i=new Intent(quizhActivity.this,MainActivity.class);
                                startActivity(i);
                                finish();
                            }
                        })
