...
public class ResultHardActivity extends AppCompatActivity {
    ...
    //static ResultHardActivity INSTANCE;
       ...
       /* for(int tabIndex=0;tabIndex  <tabHost.getTabWidget().getTabCount();tabIndex++)
        ...
        restart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(ResultHardActivity.this,CategoryActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public void onBackPressed()
    {
        ...
        AlertDialog.Builder builder=new AlertDialog.Builder(ResultHardActivity.this);
