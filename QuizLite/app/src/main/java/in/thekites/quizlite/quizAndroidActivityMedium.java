...
public class quizAndroidActivityMedium extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DbHelperAndroidMedium db = new DbHelperAndroidMedium(this);
        ...
        opta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(a==0) {
                    next = new Button(quizAndroidActivityMedium.this);
                    next.setText("Next");
                    next.setTextColor(getResources().getColor(R.color.changeOption2));
                    next.setOnClickListener(quizAndroidActivityMedium.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder=new AlertDialog.Builder(quizAndroidActivityMedium.this);
                builder.setMessage("Do you want to close the test?")
                        .setCancelable(false)
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Intent i=new Intent(quizAndroidActivityMedium.this,CategoryActivity.class);
                                startActivity(i);
                                finish();
                            }
                        })
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("Do you want to close the test?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Intent i=new Intent(quizAndroidActivityMedium.this,ResultActivity.class);
                                startActivity(i);
                                finish();
                            }
                        })
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("Do you want to go to Home?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Intent i=new Intent(quizAndroidActivityMedium.this,MainActivity.class);
                                startActivity(i);
                                finish();
                            }
                        })
