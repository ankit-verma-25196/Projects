...
public class quizActivityHard extends AppCompatActivity implements View.OnClickListener {
...
//    RelativeLayout r1=(RelativeLayout)findViewById(R.id.r1);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DbHelperHard db = new DbHelperHard(this);
        ...
        opta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (a == 0) {
                    next = new Button(quizActivityHard.this);
                    next.setText("Next");
                    next.setTextColor(getResources().getColor(R.color.changeOption2));
                    next.setOnClickListener(quizActivityHard.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder=new AlertDialog.Builder(quizActivityHard.this);
                builder.setMessage("Do you want to close the test?")
                        .setCancelable(false)
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Intent i=new Intent(quizActivityHard.this,CategoryActivity.class);
                                startActivity(i);
                                finish();
                            }
                        })
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("Do you want to close the test?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Intent i=new Intent(quizActivityHard.this,ResultActivity.class);
                                startActivity(i);
                                finish();
                            }
                        })
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("Do you want to go to Home?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Intent i=new Intent(quizActivityHard.this,MainActivity.class);
                                startActivity(i);
                                finish();
                            }
                        })
