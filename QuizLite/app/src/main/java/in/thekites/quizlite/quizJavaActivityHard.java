...
public class quizJavaActivityHard extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DbHelperJavaHard db = new DbHelperJavaHard(this);
        ...
        opta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(a==0) {
                    next = new Button(quizJavaActivityHard.this);
                    next.setText("Next");
                    next.setTextColor(getResources().getColor(R.color.changeOption2));
                    next.setOnClickListener(quizJavaActivityHard.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder=new AlertDialog.Builder(quizJavaActivityHard.this);
                builder.setMessage("Do you want to close the test?")
                        .setCancelable(false)
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Intent i=new Intent(quizJavaActivityHard.this,CategoryActivity.class);
                                startActivity(i);
                                finish();
                            }
                        })
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("Do you want to close the test?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Intent i=new Intent(quizJavaActivityHard.this,ResultActivity.class);
                                startActivity(i);
                                finish();
                            }
                        })
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("Do you want to go to Home?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Intent i=new Intent(quizJavaActivityHard.this,MainActivity.class);
                                startActivity(i);
                                finish();
                            }
                        })
